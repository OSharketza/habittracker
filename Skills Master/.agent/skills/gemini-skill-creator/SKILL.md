---
name: managing-gemini-skills
description: Generates high-quality, predictable, and efficient .agent/skills/ directories based on user requirements. Use when creating or updating skills for the Antigravity agent.
---
